"""
Settings pour Robot Lab.
Les variables sensibles sont lues depuis le fichier .env via python-decouple.
"""
from decouple import config

# ── Sécurité ──────────────────────────────────────────────────────────────────
SECRET_KEY = config('SECRET_KEY', default='django-insecure-robot_lab-change-in-production')
...
# ── Base de données ────────────────────────────────────────────────────────────
_DB_SCHEMA = config('DB_SCHEMA', default='robot_lab')
...
# ── engine/ (moteur d'enregistrement/exécution Playwright) ──────────────────────
# Secret partagé pour le callback interne de vérification de ticket WS — même
